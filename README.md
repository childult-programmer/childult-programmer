...
- **Efficient VLMs**: Reducing the computational cost of large vision-language models through token pruning and efficient representation learning while preserving visual grounding capabilities.
...
### 📃 Publications
- **S Lee** and Y Choi, **CLIP Tricks You: Training-free Token Pruning for Efficient Pixel Grounding in Large Vision-Language Models**. Jul. 2026, ICML. [[paper](https://arxiv.org/abs/2605.13178)][[code](https://github.com/sejong-rcv/LiteLVLM)]
...
🔍[Google Scholar](https://scholar.google.com/citations?user=MO_dSVUAAAAJ&hl=ko) / 📝[Homepage](https://childult-programmer.github.io/)
